...
export const toolDefinitions = {
  ...
  update_profile: {
    ...
    inputSchema: z.object({
      ...
      purpose: z.string().optional().describe('Ucel: vlastni_bydleni, investice, refinancovani (zmena banky), refixace (zmena sazby u stavajici banky), prodej (klient prodava nemovitost)'),
      ...
      employmentType: z.enum(['zamestnanec', 'osvc', 'kombinace']).optional().describe('Typ prijmu: zamestnanec, osvc (podnikatel/zivnostnik), kombinace. VZDY uloz kdyz klient zmini ze podnika, je OSVC, zivnostnik, freelancer.'),
