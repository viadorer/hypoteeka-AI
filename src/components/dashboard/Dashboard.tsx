...
export function Dashboard({ sessionId, onContinueChat, onNewChat }: DashboardProps) {
  ...
  if (loading) {
    return (
      <div className="flex-1  flex items-center justify-center min-h-screen pt-16 md:pt-0 overflow-x-hidden">
  ...
  if (!session) {
    return (
      <div className="flex-1  flex flex-col items-center justify-center min-h-screen pt-16 md:pt-0 px-4 overflow-x-hidden">
  ...
  return (
    <div className="flex-1  min-h-screen pt-16 md:pt-0 overflow-y-auto overflow-x-hidden min-w-0 w-full">
